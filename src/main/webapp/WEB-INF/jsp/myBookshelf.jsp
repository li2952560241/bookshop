...
<%--            <li><a href="#">服务区</a></li>--%>
<%--      服务区      原始代码这里不知道有什么想法，而且原作者也没有实现，但是我自己没有理解要干嘛，所以暂时注解，--%>
        </ul>
    </div><!-- nav-menu -->
...
<div class="person-info">
    ...
    <p class="set">
        <a href="/users/update?id=${user.id}" class="edit">编辑个人主页</a>

    <%--        <a href="#" class="edit">编辑个人主页</a> 没有实现这个功能  我已实现
    自己完善思路 写一个函数，点击编辑个人主页，跳转到一个页面，页面上显示个人信息，可以修改个人信息，修改完毕后点击保存，跳转到个人主页，显示修改后的个人信息，--%>
<%--        这个点击编辑个人主页有什么意义  # 表示一个临时连接--%>
...
<%--                编辑图书 跳转到相关的页面，需要传参，参数是book的id，通过id获取book的信息，然后显示在页面上，用户可以修改，修改完毕后点击保存，跳转到我的书架，显示修改后的信息，--%>
