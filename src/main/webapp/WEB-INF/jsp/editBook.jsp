...
<div class="container">
    <form enctype="multipart/form-data" id="bookForm" action="updateBook" method="post">
        <input type="hidden" name="id" value="${book.id}" id="bookId">
        <p>
            <span class="pic-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            修改书图片： <input type="file" id="book-file" name="image">
            <img id="book-pic" src="<%=request.getContextPath()%>/img/book-list/article/${book.bookImage.id}.jpg">
        </p>
        <p>
            <span class="name-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            书&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：<input type="text" name="name" value="${book.name}" id="bookName">
        </p>
        <p>
            <span class="author-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;者：<input type="text" name="author" value="${book.author}" id="bookAuthor">
        </p>
        <p>
            <span class="name-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            分&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类：<select id="category" name="category.id">
            <c:forEach items="${categories}" var="category">
                <option value="${category.key}" ${category.key == book.category.id ? 'selected' : ''}>${category.value}</option>
            </c:forEach>
        </select>
        </p>
        <p>
            <span class="origin-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            书&nbsp;本&nbsp;&nbsp;原&nbsp;价：<input type="text" name="originalPrice" value="${book.originalPrice}" id="bookOriginalPrice">
        </p>
        <p>
        ...
        <p>
            ...
            出&nbsp;&nbsp;&nbsp;&nbsp;版&nbsp;&nbsp;&nbsp;社：<input type="text" name="press" value="${book.press}" id="bookPress">
        </p>
        <p>
            <span class="time-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            出&nbsp;版&nbsp;&nbsp;时&nbsp;间：<input type="month" name="publishDate" value="${book.publishDate}" id="bookDate">
        </p>
        <p>
        ...
        <p>
            ...
            书&nbsp;本&nbsp;&nbsp;描&nbsp;述：<input type="text" name="description" value="${book.description}" id="bookDescription">
        </p>
